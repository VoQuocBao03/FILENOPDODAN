...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("------------------------- MENU QUAN LY KHO SACH -------------------------");
            ...
            switch (choice) {
                ...
                for (int i = 0; i < soSachKhoaHoc; i++) {
                    System.out.println("NHAP THONG TIN QUYE SACH THU " + (i + 1));
                ...
                for (int i = 0; i < soTruyenTranh; i++) {
                    System.out.println("NHAP THONG TIN QUYEN TRUYEN TRANH THU " + (i + 1));
